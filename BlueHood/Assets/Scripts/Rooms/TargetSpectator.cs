using BlueHood.Behaviour.Enemies.Data;
...
namespace BlueHood.Rooms
{
    public class TargetSpectator : MonoBehaviour
    {
        ...
        public virtual void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            else if(intruder.TryGetComponent<Behaviour.Player>(out var target)) // Here dedicated Player class
            {
                _target = target;
            }
        }
        ...
        public virtual void OnTriggerExit2D(Collider2D collision)
        {
            ...
            else if(leaver.TryGetComponent<Behaviour.Player>(out var target)) // Here dedicated Player class
            {
                _target = null;
